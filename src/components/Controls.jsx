export default function Controls({
  ...
  return (
    <div className="controls">
      <button className="btn btn-muted settings-btn" onClick={onRestart} aria-label="Restart" title="Restart">
      ...
      <button className="btn btn-muted settings-btn" onClick={onSkip} aria-label="Skip" title="Skip">
        <svg className="w-[37px] h-[37px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
